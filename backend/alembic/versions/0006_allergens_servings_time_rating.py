...
Revision ID: 0006_allergens_servings_time_rating
...
revision = "0006_allergens_servings_time_rating"
...
"""add allergens + default_servings to users; prep/cook time + rating to recipes
...
def downgrade() -> None:
    op.drop_constraint("ck_recipes_user_rating", "recipes", type_="check")
    op.drop_column("recipes", "user_rating")
    op.drop_column("recipes", "cook_time_minutes")
    op.drop_column("recipes", "prep_time_minutes")
